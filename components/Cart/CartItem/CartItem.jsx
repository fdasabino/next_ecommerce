...
const CartItem = ({ cartProducts }) => {
    ...
    const increaseCartQuantity = () => {
        ...
        dispatch(
            updateCart({ ...cartProducts, id: cartProducts._uid, addedQuantity: newQuantity })
        );
    ...
    const decreaseCartQuantity = () => {
        if (cartQuantity > 1) {
            ...
            toast.info(
                `Quantity updated for "${cartProducts.name}". New quantity: ${newQuantity}.`
            );
        }
    };
                    ...
                    <div className={styles.totals}>
                        <small>
                            {itemWithDiscount.find(
                                ...
                                `$${(
                                    cartProducts.priceBeforeDiscount * cartProducts.addedQuantity
                                ).toFixed(2)}`}
                        </small>
                        <p>
                            $
