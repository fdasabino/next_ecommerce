  ...
  return (
    <div className={`${styles.profile_sidebar} ${isExpanded ? styles.expanded : ""}`}>
      ...
      <ul className={styles.nav_list}>
        ...
        <li className={`${styles.nav_item} ${path === "/profile/orders" ? styles.active : ""}`}>
          <Link
            onClick={toggleSidebar}
            href="/profile/orders">
        ...
        <li className={`${styles.nav_item} ${path === "/profile/messages" ? styles.active : ""}`}>
          <Link
            onClick={toggleSidebar}
        ...
        <li className={`${styles.nav_item} ${path === "/profile/addresses" ? styles.active : ""}`}>
          <Link
            onClick={toggleSidebar}
        ...
        <li className={`${styles.nav_item} ${path === "/profile/wishlist" ? styles.active : ""}`}>
          <Link
            onClick={toggleSidebar}
